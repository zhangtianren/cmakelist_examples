...
struct RtpParameters {
  ...
  const RtpParameters & operator = (const RtpParameters & parameters) {
    this->mid = parameters.mid;
    this->transaction_id = parameters.transaction_id;
    this->codecs = parameters.codecs;
    this->header_extensions = parameters.header_extensions;
    this->encodings = parameters.encodings;
    this->degradation_preference = parameters.degradation_preference;
    return *this;
  }
};
