...
class PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  struct RTCConfiguration {
    ...
    // Support socks version 5 proxy, default is none.
...
class PeerConnectionFactoryInterface : public rtc::RefCountInterface {
 public:
  ...
  // Starts auido processing module dump using existing file.
  virtual bool StartApmDump(rtc::PlatformFile file, int64_t max_size_bytes, uint32_t options) = 0;

  // Stops logging the audio processing module dump.
  virtual void StopApmDump() = 0;

  // Installs a VoEMediaProcess derived instance and activates external
  // media for the specified |type| (kRecordingAllChannelsMixed and kRecordingPreprocessing).
  ...
  // media for the specified |type| (kRecordingAllChannelsMixed and kRecordingPreprocessing).
  virtual int DeRegisterExternalMediaProcessing(ProcessingTypes type) = 0;
