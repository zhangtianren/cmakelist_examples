...
BEGIN_SIGNALING_PROXY_MAP(PeerConnectionFactory)
  ...
  PROXY_METHOD3(bool, StartApmDump, rtc::PlatformFile, int64_t, uint32_t)
  PROXY_METHOD0(void, StopApmDump)
  PROXY_METHOD2(int, RegisterExternalMediaProcessing, ProcessingTypes, VoEMediaProcess*)
  PROXY_METHOD1(int, DeRegisterExternalMediaProcessing, ProcessingTypes)
